          ...
          <Text style={styles.detailsText}>
            {friend.gender === "female"
              ...
              : friend.gender === "male"
                ? "👨"
                : "👤"}{" "}
            • {friend.age} • {country?.flag} {country?.name}
          </Text>
        </View>
      </View>
    </TouchableOpacity>
...
export const FriendsPickerModal = forwardRef<
  FriendsPickerModalRef,
  FriendsPickerModalProps
>(({ onFriendSelect }, ref) => {
  const theme = useTheme();
  ...
  const renderFriendItem = useCallback(
    ({ item }: { item: Friend }) => (
      <FriendItem friend={item} onPress={() => handleFriendPress(item)} t={t} />
    ),
    [handleFriendPress, t],
  );

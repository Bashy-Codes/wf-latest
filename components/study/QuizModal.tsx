          ...
          <View style={styles.container}>
            <View style={styles.card}>
              ...
              <View style={styles.resultContainer}>
                <Ionicons name="alert-circle" size={scale(64)} color={theme.colors.textSecondary} />
                <Text style={[styles.resultText, { marginTop: verticalScale(20) }]}>
              ...
              <View style={styles.resultContainer}>
                <View style={styles.resultIcon}>
                  {score / questions.length >= 0.7 ? (
                    <Ionicons name="trophy" size={scale(80)} color="#FFD700" />
                  ) : (
                    <Ionicons name="ribbon" size={scale(80)} color={theme.colors.primary} />
                  )}
                </View>
